...
const AddEdit = () =>{
	...
	useEffect(()=>{
		axios.get(`https://calm-bayou-47543.herokuapp.com/api/get/${id}`).then((resp)=> setState({...resp.data[0]}));
	},[id]);
	...
	const handleSubmit = (e) =>{
		...
		if (!name || !lastname || !nickname || !age || !contacts || !wins || !losses){
		 ...
		 if(!id){
			axios
				.post("https://calm-bayou-47543.herokuapp.com/api/post", {
					name,
					lastname,
					nickname,
					age,
			...
			.then(()=>{
				...
				window.location('https://calm-bayou-47543.herokuapp.com/')
			...
			axios
				.put(`https://calm-bayou-47543.herokuapp.com/api/update/${id}`, {
					name,
					lastname,
					nickname,
					age,
